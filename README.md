...
See the [open issues](https://github.com/XAOSTECH/XAOSTECH/issues) for a full list of proposed features and known issues.
...
- 📝 **Wiki**: [GitHub Wiki](https://github.com/XAOSTECH/XAOSTECH/wiki)
